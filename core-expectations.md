...
_I evaluate every teammate along this first and foremost - they determine how autonomous you can be._
...
_"My epic is done 20 of 31 tickets, and I suspect we're a couple days behind, mainly due to the db migration taking a few days longer than I estimated. I need you to decide if we want to change scope (we could drop these 1-3 tickets to get back on track) or change target date."_
...
_"I'm going to pull in this ticket early even though it's in next sprint because it'll actually remove the need for 2 tickets in sprint"_

## Detailed Expectations
When I need a full framework, I lean on the [Engineering Ladder](https://www.engineeringladders.com/Developer.html#d4---developer-4). But usually this is only if the orgs expectations leave something ambiguous.
