...
- [ ] **Phase 1: Content Map and Required Fixes** - Resolve taxonomy decisions and apply the three flagged content fixes before any content moves
...
**Goal**: Every item in the current readme has an unambiguous destination file, and the three flagged structural trust issues are resolved in the source before extraction begins
